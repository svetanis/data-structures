...
public final class TasksScheduling {
	...
	public static ImmutableList<String> taskScheduling(List<String> tasks, List<List<String>> requirements) {
		Map<String, List<String>> graph = graph(tasks, requirements);
		return topoSort(graph);
	}

	private static ImmutableList<String> topoSort(Map<String, List<String>> graph) {
		...
		return ts ? newList(list) : newList();
	}
