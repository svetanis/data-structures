...
// The node carries an index into the root list, so the replacement is
// list.get(index). ReplaceWordsMark carries a boolean instead.

public final class ReplaceWordsIndex {
