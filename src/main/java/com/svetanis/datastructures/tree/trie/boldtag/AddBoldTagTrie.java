package com.svetanis.datastructures.tree.trie.boldtag;
...
// A trie of the words, walked from every position of s: each word end is an
// interval, the intervals are merged, and the tags go around the merged ones.
// AddBoldTagIndexOf gets the same answer with no trie.

public final class AddBoldTagTrie {
