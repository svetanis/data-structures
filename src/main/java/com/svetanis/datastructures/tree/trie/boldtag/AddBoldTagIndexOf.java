...
// No trie: indexOf finds every occurrence of every word, marks its letters
// bold in a boolean array, and one pass opens and closes the tags.

public final class AddBoldTagIndexOf {
