...
public final class ClosestToTargetRecursive {
	// Time complexity: O(h)

	// ties are kept as first-met, so this is not LC 270 -- that problem
	// wants the smallest of the tied values. ClosestToTarget.java is the
	// one to submit
